// Run this ONCE on your own machine to get your initial Spotify refresh token.
// Requires Node 18+ (for global fetch). No npm packages needed.
//
// Usage:
//   1. Set CLIENT_ID below (or via env var SPOTIFY_CLIENT_ID).
//   2. In your Spotify app dashboard, add this exact redirect URI:
//        http://127.0.0.1:8888/callback
//   3. Run:  node get-refresh-token.js
//   4. Your browser opens automatically. Log in and click "Agree".
//   5. The script prints your refresh_token and an authorized_at timestamp.
...
const CLIENT_ID = process.env.SPOTIFY_CLIENT_ID || "c72b2fba6066479aae8dbf7d34dde38a";
...
if (CLIENT_ID === "c72b2fba6066479aae8dbf7d34dde38a") {
  console.error(
    "Set your Spotify client ID first — either edit CLIENT_ID in this file\n" +
      "or run: SPOTIFY_CLIENT_ID=xxxx node get-refresh-token.js"
  );
  process.exit(1);
}
